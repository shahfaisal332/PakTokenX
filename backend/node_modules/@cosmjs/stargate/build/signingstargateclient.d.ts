...
import { DynamicGasPriceConfig } from "./feemarket";
...
export declare class SigningStargateClient extends StargateClient {
    ...
    private readonly defaultDynamicGasPriceMultiplier;
    /**
     ...
     * auto-detection.
     */
    static createWithSigner(cometClient: CometClient, signer: OfflineSigner, options?: SigningStargateClientOptions): SigningStargateClient;
    /**
     ...
     */
    private calculateFeeForTransaction;
    /**
