...
function setupIbcExtension(base) {
    ...
    return {
        ibc: {
            ...
            transfer: {
                denomTrace: async (hash) => transferQueryService.Denom({ hash: hash }),
                denomTraces: async (paginationKey) => transferQueryService.Denoms({
                    pagination: (0, queryclient_1.createPagination)(paginationKey),
                }),
                allDenomTraces: async () => {
                    ...
                    return query_1.QueryDenomsResponse.fromPartial({
                        denoms: denomTraces,
                    });
                },
