 ...
 */
export declare function isEthereumSecp256k1Account(account: AccountData): boolean;
/**
 ...
 */
export declare function getAminoPubkey(account: AccountData): EthSecp256k1Pubkey | Secp256k1Pubkey;
