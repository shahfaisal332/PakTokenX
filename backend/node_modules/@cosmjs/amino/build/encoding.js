...
const pubkeyAminoPrefixEthSecp256k1 = (0, encoding_1.fromHex)("5D7423DF" + "21" /* fixed length */);
...
function encodeAminoPubkey(pubkey) {
    ...
    else if ((0, pubkeys_1.isEthSecp256k1Pubkey)(pubkey)) {
        return new Uint8Array([...pubkeyAminoPrefixEthSecp256k1, ...(0, encoding_1.fromBase64)(pubkey.value)]);
    }
    else {
