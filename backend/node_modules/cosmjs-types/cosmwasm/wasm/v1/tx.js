...
class MsgClientImpl {
    ...
    RemoveCodeUploadParamsAddresses(request) {
        ...
        return promise.then((data) => exports.MsgRemoveCodeUploadParamsAddressesResponse.decode(new binary_1.BinaryReader(data)));
    }
    AddCodeUploadParamsAddresses(request) {
        ...
        return promise.then((data) => exports.MsgAddCodeUploadParamsAddressesResponse.decode(new binary_1.BinaryReader(data)));
    }
    StoreAndMigrateContract(request) {
        ...
        return promise.then((data) => exports.MsgStoreAndMigrateContractResponse.decode(new binary_1.BinaryReader(data)));
    }
    UpdateContractLabel(request) {
        ...
        return promise.then((data) => exports.MsgUpdateContractLabelResponse.decode(new binary_1.BinaryReader(data)));
    }
}
