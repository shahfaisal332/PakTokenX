...
exports.TxBody = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.timeoutTimestamp !== undefined) {
            timestamp_1.Timestamp.encode(message.timeoutTimestamp, writer.uint32(42).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_1.isSet)(object.unordered))
            obj.unordered = Boolean(object.unordered);
        if ((0, helpers_1.isSet)(object.timeoutTimestamp))
            obj.timeoutTimestamp = (0, helpers_1.fromJsonTimestamp)(object.timeoutTimestamp);
    ...
    toJSON(message) {
        ...
        message.timeoutTimestamp !== undefined &&
            (obj.timeoutTimestamp = (0, helpers_1.fromTimestamp)(message.timeoutTimestamp).toISOString());
    ...
    fromPartial(object) {
        ...
        if (object.timeoutTimestamp !== undefined && object.timeoutTimestamp !== null) {
            message.timeoutTimestamp = timestamp_1.Timestamp.fromPartial(object.timeoutTimestamp);
        }
