...
class QueryClientImpl {
    ...
    ClientCreator(request) {
        const data = exports.QueryClientCreatorRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.client.v1.Query", "ClientCreator", data);
        return promise.then((data) => exports.QueryClientCreatorResponse.decode(new binary_1.BinaryReader(data)));
    }
