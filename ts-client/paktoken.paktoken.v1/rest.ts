...
import { QueryParamsResponse } from "./types/paktoken/paktoken/v1/query";

import { QueryParamsRequest } from "./types/paktoken/paktoken/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/paktoken/paktoken/v1/params
   */
  queryParams = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsResponse>>>({
      path: `/paktoken/paktoken/v1/params`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
