import { Ed25519Pubkey, EthSecp256k1Pubkey, Pubkey, Secp256k1Pubkey } from "./pubkeys";
/**
 ...
 * representation of it (the type/value wrapper object).
 */
export declare function encodeEthSecp256k1Pubkey(pubkey: Uint8Array): EthSecp256k1Pubkey;
/**
 ...
 */
export declare function encodeAminoPubkey(pubkey: Pubkey): Uint8Array<ArrayBuffer>;
/**
