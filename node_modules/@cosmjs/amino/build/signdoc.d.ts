...
export declare function makeSignDoc(msgs: readonly AminoMsg[], fee: StdFee, chainId: string, memo: string | undefined, accountNumber: number | string | bigint, sequence: number | string, timeout_height?: bigint): StdSignDoc;
/**
...
export declare function serializeSignDoc(signDoc: StdSignDoc): Uint8Array<ArrayBuffer>;
