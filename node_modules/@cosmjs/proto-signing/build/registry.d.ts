...
export interface TsProto2GeneratedType {
    readonly encode: (message: any | {
        [k: string]: any;
    }, writer?: bbw.BinaryWriter) => bbw.BinaryWriter;
...
export type GeneratedType = TelescopeGeneratedType | TsProtoGeneratedType | TsProto2GeneratedType | PbjsGeneratedType;
export declare function hasFromPartial(type: GeneratedType): type is TelescopeGeneratedType | TsProtoGeneratedType | TsProto2GeneratedType;
export declare function hasCreate(type: GeneratedType): type is PbjsGeneratedType;
...
export declare class Registry {
     ...
     */
    encode(encodeObject: EncodeObject): Uint8Array<ArrayBuffer>;
    /**
     * Takes a typeUrl/value pair and encodes the value to an Any if
     * the given type was previously registered.
     */
    encodeAsAny(encodeObject: EncodeObject): Any;
    encodeTxBody(txBodyFields: TxBodyValue): Uint8Array<ArrayBuffer>;
