...
exports.QueryBuildAddressRequest = {
    ...
    toJSON(message) {
        ...
        message.initArgs !== undefined &&
            (obj.initArgs = (0, helpers_1.base64FromBytes)(message.initArgs !== undefined ? message.initArgs : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryBuildAddressRequest();
...
class QueryClientImpl {
    ...
    CodeInfo(request) {
        ...
        return promise.then((data) => exports.QueryCodeInfoResponse.decode(new binary_1.BinaryReader(data)));
    }
    PinnedCodes(request = {
        pagination: pagination_1.PageRequest.fromPartial({}),
    }) {
    ...
    WasmLimitsConfig(request = {}) {
        ...
        return promise.then((data) => exports.QueryWasmLimitsConfigResponse.decode(new binary_1.BinaryReader(data)));
    }
    BuildAddress(request) {
        ...
        return promise.then((data) => exports.QueryBuildAddressResponse.decode(new binary_1.BinaryReader(data)));
    }
}
