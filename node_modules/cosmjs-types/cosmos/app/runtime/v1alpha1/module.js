...
exports.Module = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.skipStoreKeys))
            obj.skipStoreKeys = object.skipStoreKeys.map((e) => String(e));
        if (Array.isArray(object?.orderMigrations))
            obj.orderMigrations = object.orderMigrations.map((e) => String(e));
        if (Array.isArray(object?.precommiters))
            obj.precommiters = object.precommiters.map((e) => String(e));
        if (Array.isArray(object?.prepareCheckStaters))
            obj.prepareCheckStaters = object.prepareCheckStaters.map((e) => String(e));
        if (Array.isArray(object?.preBlockers))
            obj.preBlockers = object.preBlockers.map((e) => String(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
