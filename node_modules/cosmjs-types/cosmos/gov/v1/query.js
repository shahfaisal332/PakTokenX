...
exports.QueryConstitutionResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_1.isSet)(object.constitution))
            obj.constitution = String(object.constitution);
        return obj;
    },
    toJSON(message) {
        const obj = {};
...
class QueryClientImpl {
    ...
    Constitution(request = {}) {
        ...
        return promise.then((data) => exports.QueryConstitutionResponse.decode(new binary_1.BinaryReader(data)));
    }
    Proposal(request) {
