...
class MsgClientImpl {
    ...
    DeleteClientCreator(request) {
        const data = exports.MsgDeleteClientCreator.encode(request).finish();
        const promise = this.rpc.request("ibc.core.client.v1.Msg", "DeleteClientCreator", data);
        return promise.then((data) => exports.MsgDeleteClientCreatorResponse.decode(new binary_1.BinaryReader(data)));
    }
}
